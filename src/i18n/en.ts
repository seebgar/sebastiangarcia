...
const dict: Dict = {
    meta: {
        ...
        description: "Sebastian Garcia Resume.",
    },
    nav: {
        about: "About",
        resume: "Resume",
    ...
    resume: {
        ...
        skills: {
            ...
            cloudDevOps: {
                label: "Cloud & DevOps",
                items: "Google Cloud Platform (GCP), Microsoft Azure, Amazon Web Services (AWS), Kubernetes, Continuous Integration and Continuous Delivery (CI/CD), Agile Methodologies.",
